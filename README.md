...
* [Proton-CachyOS](https://github.com/CachyOS/proton-cachyos/releases) and [Proton-GE](https://github.com/gloriouseggroll/proton-ge-custom) can be used instead of Valve-Proton. Some games may only work with [Proton-GE](https://github.com/gloriouseggroll/proton-ge-custom).
